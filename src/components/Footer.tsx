        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6">
              ...
              convenience with fast shipping and exceptional customer service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/account" className="text-sm hover:text-white transition-colors">My Account</Link></li>
            </ul>
          </div>
